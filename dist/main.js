...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\n/* harmony import */ var _create_newListItem__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./create.newListItem */ \"./src/js/create.newListItem.js\");\n/* harmony import */ var _display_list_item_status__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./display.list-item-status */ \"./src/js/display.list-item-status.js\");\n\n\n\nfunction displayTaskInformation(task){\n    Object.keys(task).forEach(key => {\n        const query = document.querySelector(`.${key}`);\n        if (query){\n            if (key == 'checkList'){\n                while(query.firstElementChild){\n                    query.firstElementChild.remove();\n                }\n                displayCheckList(task[key], query);\n                query.appendChild((0,_create_newListItem__WEBPACK_IMPORTED_MODULE_0__.listItemGenerator)());\n            } else {\n                query.value = task[key];\n            }\n        }\n    })\n}\n\nfunction displayCheckList(checkList, element){\n    Object.keys(checkList).forEach(key =>{\n        let id = key;\n        let text = checkList[key][0];\n        let status = checkList[key][1];\n        const listItem = (0,_create_newListItem__WEBPACK_IMPORTED_MODULE_0__.newListItem)(id, status, text);\n        element.appendChild(listItem)\n        if (status){\n            (0,_display_list_item_status__WEBPACK_IMPORTED_MODULE_1__[\"default\"])(listItem)\n        }\n    })\n}\n\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (displayTaskInformation);\n\n//# sourceURL=webpack://odin-to_do_v2/./src/js/display.task-information.js?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _css_styles_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../css/styles.css */ \"./src/css/styles.css\");\n/* harmony import */ var _display_bundle_task_information__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./display-bundle.task-information */ \"./src/js/display-bundle.task-information.js\");\n/* harmony import */ var _display_list_item_status__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./display.list-item-status */ \"./src/js/display.list-item-status.js\");\n/* harmony import */ var _display_navigation_button__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./display.navigation-button */ \"./src/js/display.navigation-button.js\");\n/* harmony import */ var _display_new_project_button__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./display.new-project-button */ \"./src/js/display.new-project-button.js\");\n/* harmony import */ var _display_projects__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./display.projects */ \"./src/js/display.projects.js\");\n/* harmony import */ var _information_holder_project_task_unions__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./information-holder.project-task-unions */ \"./src/js/information-holder.project-task-unions.js\");\n\n\n\n\n\n\n\n\nconst projectsSelector = document.querySelector('.projects')\n\nlet info = new _information_holder_project_task_unions__WEBPACK_IMPORTED_MODULE_6__[\"default\"]();\ninfo.newProject('Personal');\ninfo.newProject('Work');\n\ninfo.projects[0].newTask(\"PersonalTask\", \"Just something to test functionality\", 'dd/mm/yyyy', 16, {\n    0 : ['do something', true],\n    1 : ['do something else', false],\n    2 : ['do nothing', true],\n    3 : ['do math', false],\n    4 : ['do meth', true],\n}, \"Something to do\");\ninfo.projects[0].tasks[0].newListItem('cry', 'true')\n\ninfo.projects[0].newTask(\"PersonalTask2\", \"Just something to test functionality\", 'dd/mm/yyyy', 16, {\n    0 : ['do something', true],\n    1 : ['do something else', false],\n    2 : ['do nothing', true],\n    3 : ['do math', false],\n    4 : ['do meth', true],\n}, \"Something to do\");\n\ninfo.projects[1].newTask(\"WorkTask\", \"Just something to test functionality\", 'dd/mm/yyyy', 16, {\n    0 : ['do something', true],\n    1 : ['do something else', false],\n    2 : ['do nothing', true],\n    3 : ['do math', false],\n    4 : ['do meth', true],\n}, \"Something to do\");\n\nlet checkList = document.querySelector('.checkList');\ncheckList.onclick = (event) => (0,_display_list_item_status__WEBPACK_IMPORTED_MODULE_2__.changeStatus)(event);\n\ninfo.projects.forEach(project => {\n    (0,_display_projects__WEBPACK_IMPORTED_MODULE_5__[\"default\"])(project);\n})\n;(0,_display_new_project_button__WEBPACK_IMPORTED_MODULE_4__[\"default\"])(info, projectsSelector);\n\n(0,_display_bundle_task_information__WEBPACK_IMPORTED_MODULE_1__[\"default\"])(info);\n\n(0,_display_navigation_button__WEBPACK_IMPORTED_MODULE_3__[\"default\"])(projectsSelector, info);\n\n\n\n//# sourceURL=webpack://odin-to_do_v2/./src/js/index.js?");
